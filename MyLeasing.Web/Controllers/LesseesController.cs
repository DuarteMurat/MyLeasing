...
namespace MyLeasing.Web.Controllers
{
    public class LesseesController : Controller
    {
        ...
        public async Task<IActionResult> Create(LesseesViewModel model) //[Bind("Id,Document,FirstName,LastName,Fixed_Phone,Cell_Phone,Address,ImageURL")]
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(LesseesViewModel model) //[Bind("Id,Document,FirstName,LastName,Fixed_Phone,Cell_Phone,Address,ImageURL")]
        {
            if (ModelState.IsValid)
            {
